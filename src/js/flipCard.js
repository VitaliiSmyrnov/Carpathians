...
refs.reviewFrontToggle3.addEventListener("click", toggleReviewCard3);
refs.reviewBackToggle3.addEventListener("click", toggleReviewCard3);
...
function toggleReviewCard3() {
  refs.reviewCard3.classList.toggle("is-flipped");
}
